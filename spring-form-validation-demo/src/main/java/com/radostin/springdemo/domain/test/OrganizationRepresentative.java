...
import com.radostin.springdemo.validation.test.AgeConstraint;
import com.radostin.springdemo.validation.test.EmailVerification;
import com.radostin.springdemo.validation.test.FieldsVerification;

@FieldsVerification.List({
		@FieldsVerification(field = "email", fieldMatch = "verifyEmail", message = "* Email addresses do not match"),
		@FieldsVerification(field = "password", fieldMatch = "verifyPassword", message = "* Passwords do not match") })
public class OrganizationRepresentative {
	...
	@EmailVerification(message = "* E-mail: is invalid")
	...
	@Size(min = 3, max = 15, message = "* Password: min 3 characters required, max 15 characters allowed")
