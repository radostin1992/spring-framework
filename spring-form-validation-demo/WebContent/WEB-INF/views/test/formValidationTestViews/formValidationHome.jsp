...
<body>
	<div align="center">
		...
		<form:form action="registerOrgRep" modelAttribute="orgrep">
			<table>
				<tr>
					<td><form:label path="firstName" cssClass="clabel">FirstName</form:label></td>
				...
				<tr>
					<td><form:label path="email" cssClass="clabel">E-mail</form:label></td>
					<td><form:input path="email" placeholder="Enter e-mail" cssClass="cinput"/></td>
				...
				<tr>
					<td><form:label path="verifyEmail" cssClass="clabel">Verify E-mail</form:label></td>
					<td><form:input path="verifyEmail" placeholder="Confirm e-mail address" cssClass="cinput"/></td>
					<td><form:errors path="verifyEmail" cssClass="cb"/>	
				</td>	
				...
				<tr>
					...
					<td><form:errors path="verifyPassword" cssClass="cb"/>	
				</td>	
