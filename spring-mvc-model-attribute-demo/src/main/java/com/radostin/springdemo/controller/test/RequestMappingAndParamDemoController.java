...
public class RequestMappingAndParamDemoController {
	...
	// test 4: Testing @RequestParam 'dafaultValie' attribute
	...
	// base URI but with different parameters
	...
	// test 6,subtest 4: Testing with multiple request and @RequestParam with single
	// param
