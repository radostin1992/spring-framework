...
<body>
	<div align="left">
		...
		<form:form action="test5" modelAttribute="anAddress">
			<h3>test5: Testing @ModelAttribute annotation with 'value'attribute and default binding</h3>
			<table>
				<tr>
		...
		<form:form action="modelAttributeTest">
			<h3>test6: Testing @ModelAttribute with no explicit logical view name</h3>
			<table>
				<tr>
