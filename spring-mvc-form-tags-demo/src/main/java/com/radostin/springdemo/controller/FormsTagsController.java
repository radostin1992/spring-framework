...
import com.radostin.springdemo.domain.test.OrganizationRegistration;
import com.radostin.springdemo.service.test.OrganizationRegistrationService;

@Controller
@RequestMapping("/formTagsDemo")

public class FormsTagsController {
	...
	public void populateFormObjectWithData(Model model) {
		...
		map.put("serviceLengthList", orgRegService.populateServiceLenghts());
